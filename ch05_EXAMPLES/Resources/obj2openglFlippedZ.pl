...
=head1 NAME
 ...
 obj2openglFlippedZ - converts obj files to arrays for glDrawArrays
 
=head1 SYNOPSIS

 obj2openglFlippedZ [options] file
...
sub writeOutput {
	...
	print OUTFILE "/*\n";
	print OUTFILE "created with obj2openglFlippedZ\n\n";
