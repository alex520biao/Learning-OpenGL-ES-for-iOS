//
//  OpenGLES_Ch6_4ViewController.m
//  OpenGLES_Ch6_4
//

#import "OpenGLES_Ch6_4ViewController.h"
...
@implementation OpenGLES_Ch6_4ViewController
...
- (void)viewDidLoad
{
   ...
   self.baseEffect.material.ambientColor = 
         GLKVector4Make(0.1f, 0.1f, 0.1f, 1.0f);
   ...
   CGImageRef imageRef0 = 
      [[UIImage imageNamed:@"RadiusSelectionTool.png"] CGImage];
