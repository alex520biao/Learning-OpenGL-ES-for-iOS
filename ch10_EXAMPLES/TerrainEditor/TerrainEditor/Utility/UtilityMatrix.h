...
static  UtilityMatrix3 
UtilityMatrix3MakeScale(float sx, float sy, float sz)
{
   UtilityMatrix3 m = UtilityMatrix3Identity;
   m.m[0] = sx;
   m.m[4] = sy;
...
static UtilityMatrix3 UtilityMatrix3MakeRotation(float radians, float x, float y, float z)
{
...
static UtilityMatrix3 UtilityMatrix3Multiply(UtilityMatrix3 matrixLeft, UtilityMatrix3 matrixRight)
{
   UtilityMatrix3 m;
...
static  UtilityMatrix3 
UtilityMatrix3Scale(UtilityMatrix3 matrix, float sx, float sy, float sz)
{
   UtilityMatrix3 m = { 
...
static UtilityMatrix3 UtilityMatrix3Rotate(UtilityMatrix3 matrix, float radians, float x, float y, float z)
{
    UtilityMatrix3 rm = UtilityMatrix3MakeRotation(radians, x, y, z);
    return UtilityMatrix3Multiply(matrix, rm);
}


static UtilityMatrix3 UtilityMatrix3Translate(UtilityMatrix3 matrix, float x, float y)
{
    UtilityMatrix3 rm = UtilityMatrix3MakeTranslation(x, y);
    return UtilityMatrix3Multiply(matrix, rm);
}
...
static UtilityMatrix4 UtilityMatrix4MakeLookAt(
   float eyeX, 
   float eyeY, 
   float eyeZ,
   float centerX, 
   ...
   float upZ)
{
    UtilityVector3 ev = { eyeX, eyeY, eyeZ };
    UtilityVector3 cv = { centerX, centerY, centerZ };
    UtilityVector3 uv = { upX, upY, upZ };
    UtilityVector3 n = UtilityVector3Normalize(UtilityVector3Add(ev, UtilityVector3Negate(cv)));
    UtilityVector3 u = UtilityVector3Normalize(UtilityVector3CrossProduct(uv, n));
    UtilityVector3 v = UtilityVector3CrossProduct(n, u);
    
    UtilityMatrix4 m = 
       { u.v[0], v.v[0], n.v[0], 0.0f,
         u.v[1], v.v[1], n.v[1], 0.0f,
         u.v[2], v.v[2], n.v[2], 0.0f,
         UtilityVector3DotProduct(UtilityVector3Negate(u), ev),
         UtilityVector3DotProduct(UtilityVector3Negate(v), ev),
         UtilityVector3DotProduct(UtilityVector3Negate(n), ev),
         1.0f 
      };
