//
//  OpenGLES_Ch10_2ViewController.m
//  OpenGLES_Ch10_2
//
...
@interface OpenGLES_Ch10_2ViewController ()
{
...
static const GLfloat OpenGLES_Ch10_2DefaultFieldOfView =
   (M_PI / 180.0f) * 45.0f;
static const GLfloat OpenGLES_Ch10_2DefaultNearLimit =
   0.5f;
static const GLfloat OpenGLES_Ch10_2DefaultFarLimit =
   5000.0f;

@implementation OpenGLES_Ch10_2ViewController
...
- (void)awakeFromNib
{
   self.dataSource = (OpenGLES_Ch10_2AppDelegate *)
...
- (void)update
{
   ...
   else 
   {
      ...
      // The camear's position will end up being set relative to
      // referencePosition in the camera position delegate
      // method
...
OpenGLES_Ch10_2DefaultSimplifaicationDistanceInTiles = 4;
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
   ...
   const GLfloat angleRad = OpenGLES_Ch10_2DefaultFieldOfView;
   
   // Configure projection and viewing/clipping volume
   [self.camera 
      configurePerspectiveFieldOfViewRad:angleRad
      aspectRatio:aspectRatio
      near:OpenGLES_Ch10_2DefaultNearLimit
      far:OpenGLES_Ch10_2DefaultFarLimit];
